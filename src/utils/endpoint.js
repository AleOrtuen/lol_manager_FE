...
export const TEAM_MEMBER_UPDATE = TEAM_MEMBER_PATH + 'update';
export const TEAM_MEMBER_DELETE = TEAM_MEMBER_PATH + 'delete';
export const TEAM_MEMBER_DELETE_TEAM = TEAM_MEMBER_PATH + 'delete-team/';
...
const PASSWORD_RESET_TOKEN_PATH = BASE_PATH + '/psw-reset/';
